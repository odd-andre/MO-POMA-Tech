...
public class Show_Deliverable_Detail extends HttpServlet { 
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) 
        ...
        try (PrintWriter out = response.getWriter()) { 
            ...
            /*Create a sqlHandler to run database queries 
                ...
                deliverableObj.getDeliverableDetail(Integer.parseInt(requestedDeliverable), out); 
                // module.add(moduleObj); 
                /*Put data into the requset for the next page allowing us to use it. */ 
                request.setAttribute("deliverableObj", deliverableObj); 
