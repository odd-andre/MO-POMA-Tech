...
public class CreateDeliverable extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {   
            Integer deliverable_Id = Integer.parseInt("deliverable_Id");
            Integer student_Id = Integer.parseInt("student_Id");
            Integer module_Id = Integer.parseInt("module_Id");
            ...
            deliverable.createDeliverable(out, deliverable_Id,student_Id, module_Id, teacher_Id, datetime_Of_Submit, status, points,feedback,progression);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CreateDeliverable.class.getName()).log(Level.SEVERE, null, ex);
        }
  }
