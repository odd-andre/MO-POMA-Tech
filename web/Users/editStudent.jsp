                    ...
                    <form action="/MO-POMA_Tech/editStudentPost" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" name="datebirth" id="datebirth" value="${student.getdatebirth()}" class="form-control" placeholder="YEAR-MONTH-DAY">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-9">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" name="zipcode" id="zipcode" value="${student.getzip_code().intValue()}" class="form-control" placeholder="Zip-code">
                            </div>
                        </div>
